 ...
 * Type System: Disallow explicit conversions from decimal literals to ``bytesXX`` types.
 * Type System: Disallow explicit conversions from hex literals to ``bytesXX`` types of different size.
